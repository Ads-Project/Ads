app.factory('categoriesAndTownsData', ['$http', '$resource', function($http, $resource) {
	...
	var townsResource = $resource('http://softuni-ads.azurewebsites.net/api/towns');
	var categoriesResource = $resource('http://softuni-ads.azurewebsites.net/api/categories');
